...
export default function SinglePlayerForm(props) {
    ...
    return (
        <>
            <form className={`bg-secondary 2xl:w-1/3 lg:w-1/2 sm:w-10/12 w-11/12 mx-auto md:px-6 px-4 py-8 rounded-3xl shadow-lg ${userEntered ? 'hidden' : 'block'}`} onSubmit={(e) => { handleSinglePlayerForm(e) }}>
                <h1 className="text-center lg:text-xl md:text-lg text-base font-bold text-primary mb-6">Enter Players info</h1>
                <div className="flex flex-col mb-4">
                    <label htmlFor="player1Name" className="font-medium md:text-base text-sm">Player's name</label>
                ...
                <div className="flex flex-col mb-4">
                    <p className="font-medium mb-2 md:text-base text-sm">Player's symbol</p>
            ...
            {/*<div className="absolute bottom-20 left-4">
                <button className="mx-auto bg-primary text-white md:py-4 py-2 px-6 rounded-md font-medium"
                onClick={() => {}}
                >Go Back</button>
    </div>*/}
        </>
